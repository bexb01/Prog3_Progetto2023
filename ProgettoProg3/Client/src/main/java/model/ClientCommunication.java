...
public class ClientCommunication implements Runnable{
    ...
    public void sendEmailToServer(int id, String sender, String receivers, Email e, String subject, String text, Date d, String options){
       //qui mi arriva una string contenete tutti i receivers non distinti
        ...
        printArrayList(arrLReceivers);//stampo tutti gli indirizzi mail slvati nell arrayList (solo per vedere se funziona) da togliere
    ...
    public static void printArrayList(ArrayList<String> list) { //da togliere era solo per vedere se funzionano le robe
